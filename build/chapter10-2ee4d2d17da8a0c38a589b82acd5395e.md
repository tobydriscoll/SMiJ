...
\end{bmatrix}
 + 
\begin{bmatrix}
D_{0,1} & \cdots & D_{0,N-1} \\ 
D_{N,1} & \cdots & D_{N,N-1}
\end{bmatrix}
\underbrace{\tilde{v}{\begin{bmatrix}
  v_1 \\ \vdots \\ v_{N-1}
\end{bmatrix}}
= \begin{bmatrix}
0 \\ 0
