...
::::{exercise}
:label: exr4-length
Plot the difference between the first 4 eigenvalues and their exact values $1, 3, 5, 7$ as functions of the domain radius `L` for `L` in the range from 1 to 10. Be sure to choose $N$ large enough to get at least 6 digits of accuracy for the eigenvalues.
::::