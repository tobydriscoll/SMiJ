...
This formula is a simple trigonometric identity away from the standard cosine expression, but only this one produces nodes that are perfectly [symmetric around zero](doi:10.1145/365723.365727) in floating-point arithmetic.
