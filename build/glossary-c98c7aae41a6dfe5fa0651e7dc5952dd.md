...
named tuple
: Tuple whose components are named and accessible via dot syntax as well as indexing.
...
tuple
: An immutable sequence of values, typically created by enclosing the values in parentheses and separating them by commas and accessible via indexing, like a vector.
