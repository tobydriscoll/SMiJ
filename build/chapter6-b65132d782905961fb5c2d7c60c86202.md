...
You're meant to compare these plots to [Output 7](#output7) for periodic functions. As Trefethen pointed out in greater detail in a [later book](doi:10.1137/1.9781611975949), the connection between Fourier and Chebyshev is both deep and wide.