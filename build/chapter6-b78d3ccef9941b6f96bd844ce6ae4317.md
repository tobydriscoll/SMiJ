...
::::{exercise}
:label: exr6-symmetry
As a continuation of Exercise 6.4 in *SMiM*. write a function to compute $(D_N)^2$ from $D_N$ efficiently by exploiting the given property. Do benchmark experiments to determine if your function is faster than squaring $D_N$ at $N=255$.
::::
