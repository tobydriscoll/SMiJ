...
We've multiplied Toeplitz matrices with vectors, too. Julia has a special way of indicating that an object is matrix-like, even when it is not truly represented by a contiguous block of all its values in memory:
