...
This structure allows the caller to provide precomputed weights if they are available, as is the case for Chebyshev points. (The rescaling in line 8 of `baryweights` is discussed in the paper I cited above.)
