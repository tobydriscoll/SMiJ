...
The matrix in brackets, with first and last rows dropped, is the modified differentiation matrix $\tilde{D}_N^2$ that incorporates the Neumannboundary conditions.
