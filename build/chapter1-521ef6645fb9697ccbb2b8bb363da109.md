...
::::{exercise}
:label: exr1-order2
Modify [Program 1](#p1) to use the second-order finite difference formula instead of the fourth-order one. Be sure to modify the dashed line and its label as well.
::::
