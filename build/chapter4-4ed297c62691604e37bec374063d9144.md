...
This would be necessary in order to change the off-diagonal elements, for example. Other functions will see this as a generic matrix without special structure. You can also specify elements on other diagonals, as in
