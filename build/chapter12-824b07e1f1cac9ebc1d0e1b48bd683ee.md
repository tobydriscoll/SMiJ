...
If we want to extend `gauss` to work in higher precision, we have to be more careful. we need an eigensolver that works with that type. Those exist, but the relative cost is much higher than for Clenshaw–Curtis.
