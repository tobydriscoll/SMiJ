...
Use the matrix-free strategy described in @exr9-3D to solve Exercise 9.5 from *SMiM*, which asks you to find the lowest eigenvalues of the Laplacian in a disk. 
::::
