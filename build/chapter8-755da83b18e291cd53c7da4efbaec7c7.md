...
I made a change compared to both Output 18 from *SMiM* and [Output 11](#output11). For the right-hand column, I show the discrete error as markers as before, but instead of connecting them with straight lines, I use `chebinterp` to show the error as a continuous function. 
...
::::{caution}
It's tempting to distill lines 27–28 into the multiple assignment
