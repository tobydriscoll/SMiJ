...
::::{tip} *SMiM* Exercise 3.5
See the [earlier tip](#tictoc) regarding timing execution of code.
::::

::::{tip} *SMiM* Exercise 3.8
The `exp` function applied to a matrix argument computes the matrix exponential, as opposed to `exp.`, which computes the elementwise scalar exponential.
::::
...
::::{exercise}
:label: exr3-lferror
Determine how the size of the wrong-direction error bump in [Output 6](#output6) and [Output 6-anim](#output6anim) depends on $\Delta t$. What do you suspect causes this error? Can you find a way to fix it, i.e., make it $O(\Delta t^2)$ as expected for leap frog?
::::
