...
This formula is a simple trigonometric identity away from the standard cosine expression, but only this one produces nodes that are perfectly symmetric around zero in floating-point arithmetic [](doi:10.1145/365723.365727).
...
You're meant to compare these plots to [Output 7](#output7) for periodic functions. As Trefethen pointed out in a [later book](doi:10.1137/1.9781611975949), the connection between Fourier and Chebyshev is both deep and wide.