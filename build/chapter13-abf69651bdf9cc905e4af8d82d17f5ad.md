...
Setting the boundary values explicitly this way is fine for using Euler in time. But time-dependent boundary conditions can be tricky with higher-order methods, particularly Runge–Kutta methods. See, for example, the discussion in [Fornberg's book](doi:10.1017/CBO9780511626357).  
