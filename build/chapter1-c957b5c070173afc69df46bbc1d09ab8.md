...
You can use `@timed` from base Julia to get the time taken by a command. But you will get more accurate results from installing the `BenchmarkTools` package, which averages over multiple calls:
