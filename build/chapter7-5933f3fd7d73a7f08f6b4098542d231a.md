...
I have departed from the original `p13.m` significantly. Rather than using `polyfit` to interpolate the solution to a finer grid, I have used the barycentric interpolation formula presented in the exercises of Chapter 6. This is a much faster and stabler method, as Trefethen made clear in a [paper](doi:10.1137/S0036144502417715) published after *SMiM*.
